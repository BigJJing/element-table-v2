  ...
  return defineComponent({
    ...
    setup(props, { emit, expose, slots }) {
      ...
      const rowsToRender = computed(() => {
        ...
        return [
          Math.max(0, startIndex - cacheBackward),                        //rowCacheStart
          Math.max(0, Math.min(totalRow - 1, stopIndex + cacheForward)),  //rowCacheEnd
          startIndex,   //rowVisibleStart
          stopIndex     //rowVisibleEnd
        ];
      });
      ...
      const renderWindow = () => {
        const Container = resolveDynamicComponent(props.containerElement);  //"div"
